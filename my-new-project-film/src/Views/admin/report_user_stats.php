...
<div class="report-page">
    <div class="report-header">
        ...
        <div class="report-actions">
            <a href="?page=export_excel&action=user_stats" class="btn-download excel">📊 Скачать Excel</a>
            <a href="?page=export_word&action=user_stats" class="btn-download word">📝 Скачать Word</a>
        ...
        <tbody>
            <?php foreach ($userStats as $user): ?>
                <tr>
                    ...
                    <td><span class="rating"><?= round($user['avg_rating'], 2) ?>/10</span></td>
                </tr>
            <?php endforeach; ?>
        </tbody>
    </table>
