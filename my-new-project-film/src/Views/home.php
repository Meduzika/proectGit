...
<div class="section">
    ...
    <a href="?page=top10" class="btn-view">👁️ Просмотр</a>           <!-- TOP-10 -->
<a href="?page=all_reviews" class="btn-view">👁️ Просмотр</a>      <!-- Все отзывы -->
<a href="?page=user_stats" class="btn-view">👁️ Просмотр</a>       <!-- Статистика пользователей -->
<a href="?page=movie_reviews" class="btn-view">👁️ Просмотр</a>    <!-- Отзывы по фильму -->
</div>
